...
export default function CreateClass(){
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-gray-800">Create Class</h1>
        <p className="text-sm text-gray-500">Define class meta and subjects — dynamic rows and validation included.</p>
      </div>
